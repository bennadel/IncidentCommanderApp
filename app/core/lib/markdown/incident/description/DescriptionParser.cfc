component
	...
	property name="htmlSanitizer" ioc:type="core.lib.markdown.incident.description.HtmlSanitizer";
	property name="markdownParser" ioc:type="core.lib.markdown.incident.description.MarkdownParser";
